...
const SEOPage = () => {
    return (
        <div className="relative">
            <Helmet>
                <title>Services - Search Engine Optimization - DeconByte Inc.</title>
                ...
                <meta property="og:title" content="Services - Search Engine Optimization - DeconByte Inc." />
            ...
            <Heading
                mainHeading="Search Engine Optimization"
                breadcrumbs={[
                { label: "Home", path: "/" },
