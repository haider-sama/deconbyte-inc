...
const WordpressDevPage = () => {
    return (
        <div className="relative">
            <Helmet>
                <title>Services - Wordpress Development - DeconByte Inc.</title>
                ...
                <meta property="og:title" content="Services - Wordpress Development - DeconByte Inc." />
            ...
            <Heading
                mainHeading="Wordpress Development"
                breadcrumbs={[
                { label: "Home", path: "/" },
