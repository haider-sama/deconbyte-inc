...
export const contactList = [
    ...
    { title: "Ardmore Blvd, Pittsburgh, PA" }
];
...
export const teamMembers = [
  ...
  },
  {
    ...
    name: 'Muhammad',
    role: 'CTO',
    description: 'Muhammad is the technical mastermind behind our operations, utilizing his extensive knowledge to ensure our technology remains cutting-edge and reliable.',
    linkedin: '/',
    github: '/',
    facebook: '/'
  },
  {
    ...
    name: 'Rehman',
    role: 'Designer',
    description: 'Rehman is the creative force shaping our visual identity, bringing his design skills to craft innovative and engaging user experiences.',
    linkedin: '/',
    github: '/',
    facebook: '/'
  },
...
export const projects = [
  {
    projectImage: "img/blank-profile.png",
    projectName: "Dispatch Trucking",
    projectLink: "/",
  },
  {
    projectImage: "img/blank-profile.png",
