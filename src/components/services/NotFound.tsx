  ...
  return (
    <div className="bg-white h-screen flex flex-col justify-center items-center">
      ...
      >
        ...
        <line fill="none" opacity="0.29" stroke="#6E6E96" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="88.866" x2="136.866" y1="245.135" y2="245.135" />
        <line fill="none" opacity="0.17" stroke="#6E6E96" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="154.732" x2="168.732" y1="245.135" y2="245.135" />
        <line fill="none" opacity="0.17" stroke="#6E6E96" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="69.732" x2="58.732" y1="245.135" y2="245.135" />
      ...
      <div className="tracking-widest mt-4 text-center">
        ...
        <span className="text-gray-500 text-xl">Sorry, we aren't providing this service at the moment!</span>
      </div>
      <div className="mt-6 text-center">
        <a href="/home" className="text-blue-600 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back</a>
      </div>
    </div>
  );
};
