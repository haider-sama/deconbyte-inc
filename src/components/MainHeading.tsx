...
const MainHeading = () => {
    ...
    return (
        <div className="mt-[16rem] z-20 relative font-bold text-center text-white w-full max-w-screen-md mx-auto">
            <h1 className="text-lg md:text-xl lg:text-2xl">Best IT Solutions</h1>
            <h1 className="pt-[1rem] text-4xl md:text-5xl lg:text-6xl">
                Leading Web Development {text}
                <span className="blinking-cursor">|</span>
            </h1>
            <h1 className="pt-[2rem] text-medium md:text-lg lg:text-xl">
