                ...
                <div className="flex flex-wrap md:flex-nowrap justify-center">
                    ...
                    <div className="w-full md:w-1/2 px-4">
                        <div className="m-8 max-w-[600px]">
                            ...
                            <br />
                            <p className="text-base text-gray-600">
                                We understand the unique challenges of different industries and strive 
                                to develop websites that not only look great but also perform excellently 
                                across all devices. Whether it's a custom web application or an enterprise 
                                solution, we're here to turn your vision into reality.
                            </p>
                            <br />
                            <p className="text-base text-gray-600">
